// Test Command:
// npm test ./test/MergeSortTest.js

const program = require('../MergeSort'); // name of the JS file
...
it('Test Case #7', function() {
  chai
    .expect(program.mergeSort([-4, 5, 10, 8, -10, -6, -4, -2, -5, 3, 5, -4, -5, -1, 1, 6, -7, -6, -7, 8]))
    .to.deep.equal([-10, -7, -7, -6, -6, -5, -5, -4, -4, -4, -2, -1, 1, 3, 5, 5, 6, 8, 8, 10]);
});

it('Test Case #8', function() {
  chai
    .expect(program.mergeSort([-7, 2, 3, 8, -10, 4, -6, -10, -2, -7, 10, 5, 2, 9, -9, -5, 3, 8]))
    .to.deep.equal([-10, -10, -9, -7, -7, -6, -5, -2, 2, 2, 3, 3, 4, 5, 8, 8, 9, 10]);
});

it('Test Case #9', function() {
  chai
    .expect(program.mergeSort([8, -6, 7, 10, 8, -1, 6, 2, 4, -5, 1, 10, 8, -10, -9, -10, 8, 9, -2, 7, -2, 4]))
    .to.deep.equal([-10, -10, -9, -6, -5, -2, -2, -1, 1, 2, 4, 4, 6, 7, 7, 8, 8, 8, 8, 9, 10, 10]);
});

it('Test Case #10', function() {
  chai
    .expect(program.mergeSort([5, -2, 2, -8, 3, -10, -6, -1, 2, -2, 9, 1, 1]))
...
it('Test Case #12', function() {
  chai
    .expect(program.mergeSort([4, 1, 5, 0, -9, -3, -3, 9, 3, -4, -9, 8, 1, -3, -7, -4, -9, -1, -7, -2, -7, 4]))
